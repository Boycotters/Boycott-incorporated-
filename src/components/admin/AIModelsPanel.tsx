...
const AI_MODELS: AIModel[] = [
  ...
  },
  {
    ...
    description: 'OpenAI GPT-5 model for complex reasoning, strategic planning, and high-stakes content review.',
    icon: Brain,
    status: 'active',
    category: 'Reasoning',
    accuracy: 96,
    requestsToday: 0,
    lastUsed: 'Active',
    capabilities: ['Multi-step reasoning', 'Strategy', 'Code review', 'Risk analysis'],
    action: 'chatbot',
  },
  {
    id: 'gpt5-mini-fast',
    name: 'GPT-5 Mini (Fast)',
    description: 'OpenAI GPT-5 Mini — fast, cost-efficient backbone for short replies and structured output.',
    icon: Zap,
    status: 'active',
    category: 'Fast LLM',
    accuracy: 92,
    requestsToday: 0,
    lastUsed: 'Active',
    capabilities: ['Low latency', 'Structured output', 'Classification', 'Cheap'],
    action: 'chatbot',
  },
  {
    id: 'gemini-3-pro',
    name: 'Gemini 3 Pro',
    description: 'Google Gemini 3 Pro — long-context, multimodal flagship for documents, images, and synthesis.',
    icon: Sparkles,
    status: 'active',
    category: 'Multimodal',
    accuracy: 95,
    requestsToday: 0,
    lastUsed: 'Active',
    capabilities: ['1M+ token context', 'Image+text', 'Synthesis', 'Translation'],
    action: 'chatbot',
  },
  {
    id: 'gemini-3-flash',
    name: 'Gemini 3 Flash',
    description: 'Google Gemini 3 Flash — default high-throughput model powering most app AI features.',
    icon: Zap,
    status: 'active',
    category: 'Fast LLM',
    accuracy: 93,
    requestsToday: 0,
    lastUsed: 'Active',
    capabilities: ['Fast', 'Multimodal', 'Tool calling', 'Default'],
    action: 'chatbot',
  },
  {
    id: 'gemini-3-pro-image',
    name: 'Gemini 3 Pro Image Gen',
    description: 'Google image generation/editing model for marketing creatives, reward art, and AI banners.',
    icon: Eye,
    status: 'active',
    category: 'Creative',
    accuracy: 90,
    requestsToday: 0,
    lastUsed: 'Active',
    capabilities: ['Text-to-image', 'Image editing', 'Brand creatives', 'Marketing'],
  },
  {
    id: 'openai-tts',
    name: 'OpenAI Voice (TTS)',
    description: 'gpt-4o-mini-tts with steerable instructions — powers the smooth human-sounding chatbot voice.',
    icon: MessageCircle,
    status: 'active',
    category: 'Voice',
    accuracy: 94,
    requestsToday: 0,
    lastUsed: 'Active',
    capabilities: ['Natural voices', 'Tone control', 'Multi-voice', 'Realtime read-aloud'],
  },
];
