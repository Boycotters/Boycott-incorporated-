...
-- Fix the duplicate award_survey_points overload causing "choosing best candidate" error
-- Drop the old 3-param version and one of the duplicate 7-param versions, then recreate cleanly

-- First drop ALL overloads
